...
try {
  db._dropDatabase("shop");
} catch (err) {}
db._createDatabase("shop");
...
var customers = db._create("customers",
                           {numberOfShards: 6, replicationFactor: 2});
var items = db._create("items", {numberOfShards: 6, replicationFactor: 2});
var sales = db._createEdgeCollection("sales",
                                     {numberOfShards: 6, replicationFactor: 2});
var baskets = db._create("baskets", {numberOfShards: 9});
var reviews = db._create("reviews", {numberOfShards: 6, replicationFactor: 2});
...
customers.insert({_key: "lulu", name: "Lustig", firstName: "Lulu",
                  ...
                  address: {street: "Neumarkt 20",
                            city: "Köln", zip: "50674"}});
customers.insert({_key: "alice", name: "alice", firstName: "First",
                  memberSince: "2017-06-16T11:44:00.000Z",
                  address: {street: "Hauptstraße 12", "city": "Horrem",
                            zip: "50169"}});
customers.insert({_key: "bob", name: "bob", firstName: "Second",
                  memberSince: "2017-06-16T11:44:45.000Z",
                  address: {street: "Hauptstraße 23", "city": "Horrem",
                            zip: "50169"}});
...
items.insert({_key: "playstation", description: "is fun", price: 199.00,
              inStock: 10000, weight: 17, shipping: 4.95,
              orderId: "123-12323-2342", supplier: "sony"});
...
sales.insert({_from: "customers/alice", _to: "items/tv",
              date: "2017-06-17T20:00:00.000Z",
              billingId: "alice-2017-0001"});
sales.insert({_from: "customers/bob", _to: "items/tv",
              date: "2017-06-17T20:00:00.000Z",
              billingId: "bob-2017-0001"});
sales.insert({_from: "customers/bob", _to: "items/playstation",
              date: "2017-06-17T20:00:00.000Z",
              billingId: "bob-2017-0001"});
